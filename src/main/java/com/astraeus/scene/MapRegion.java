...
import com.astraeus.util.ChunkUtil;
								...
								if (l18 > 0 || i19 > 0) {
									...
									if (i19 == 0) {
										...
										if ((i19 - 1) != 54) {
											...
											int k23;
											if (i23 >= 0) {
												k23 = Rasterizer3D.getOverallColour(i23);
												j23 = -1;
												...
												k23 = Rasterizer3D.hslToRgb[checkedLight(flo_2.anInt399, 96)];
												j23 = -2;
												i23 = -1;
											} else {
											...
											if ((i19 - 1) == 111) {
												k23 = Rasterizer3D.getOverallColour(1);
												j23 = -1;
												i23 = 1;
											} else if (j23 == 6363) {
												k23 = 0x483B21;
