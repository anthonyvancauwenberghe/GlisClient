...
import org.astraeus.scene.graphic.Fog;

import com.astraeus.cache.Archive;
import com.astraeus.cache.Store;
...
import com.astraeus.cache.config.VariablePlayer;
import com.astraeus.cache.def.ItemDefinition;
import com.astraeus.cache.def.NpcDefinition;
import com.astraeus.cache.def.ObjectDefinition;
import com.astraeus.cache.graphics.GameFont;
import com.astraeus.cache.graphics.IndexedImage;
import com.astraeus.cache.graphics.RSFont;
import com.astraeus.cache.graphics.Sprite;
import com.astraeus.cache.graphics.SpriteCache;
import com.astraeus.cache.graphics.Widget;
import com.astraeus.collection.Deque;
import com.astraeus.collection.Linkable;
import com.astraeus.draw.ProducingGraphicsBuffer;
import com.astraeus.draw.Rasterizer2D;
import com.astraeus.draw.Rasterizer3D;
import com.astraeus.entity.GameObject;
import com.astraeus.entity.Item;
import com.astraeus.entity.Mob;
import com.astraeus.entity.Npc;
import com.astraeus.entity.Player;
import com.astraeus.entity.Renderable;
import com.astraeus.entity.model.IdentityKit;
import com.astraeus.entity.model.Model;
import com.astraeus.io.Buffer;
import com.astraeus.net.BufferedConnection;
import com.astraeus.net.IsaacCipher;
import com.astraeus.net.requester.Resource;
import com.astraeus.net.requester.ResourceProvider;
import com.astraeus.protocol.ProtocolConstants;
import com.astraeus.scene.AnimableObject;
import com.astraeus.scene.CollisionMap;
import com.astraeus.scene.MapRegion;
import com.astraeus.scene.Projectile;
import com.astraeus.scene.SceneGraph;
import com.astraeus.scene.SceneObject;
import com.astraeus.scene.object.GroundDecoration;
import com.astraeus.scene.object.SpawnedObject;
import com.astraeus.scene.object.WallDecoration;
import com.astraeus.scene.object.WallObject;
import com.astraeus.scene.object.tile.Floor;
import com.astraeus.sign.SignLink;
import com.astraeus.sound.SoundConstants;
import com.astraeus.sound.SoundPlayer;
import com.astraeus.sound.Track;
import com.astraeus.util.ChatMessageCodec;
import com.astraeus.util.MessageCensor;
import com.astraeus.util.MiscUtils;
import com.astraeus.util.MouseDetection;
import com.astraeus.util.PacketConstants;
import com.astraeus.util.SkillConstants;
...
public class Client extends GameApplet {
      ...
      public void drawChannelButtons() {
            ...
            if (cButtonHPos == cButtonCPos) {
                  switch (cButtonHPos) {
                        ...
                        case 6:
                        case 7:
                        	SpriteCache.lookup(17).drawSprite(channelButtonsX[cButtonHPos],
                                          143 + yOffset);
                              break;
                  }
            } else {
                  switch (cButtonHPos) {
                        ...
                        case 4:
                        case 5:
                              SpriteCache.lookup(15).drawSprite(channelButtonsX[cButtonHPos],
                                          143 + yOffset);
                              break;
                        case 6:
                        	SpriteCache.lookup(18).drawSprite(channelButtonsX[cButtonHPos],
                                          143 + yOffset);
                              break;
                  }
            }
	...
	private void renderMapScene(int plane) {
    		...
    		bufferedimage.setRGB(0, 0, minimapImage.getMyWidth(), minimapImage.getMyHeight(), minimapImage.getMyPixels(), 0, minimapImage.getMyWidth());
                              ...
                              try {
                                    ...
                                    if (spriteDrawX > -1) {
                                          ...
                                          if (!Configuration.hpBar554) {
                                        	  ...
                                        	  SpriteCache.lookup(41).drawSprite(spriteDrawX - 28,
                                                            spriteDrawY - 3);
      ...
      private void loadTitleScreen() {
            ...
            System.arraycopy(flameLeftBackground.canvasRaster, 0,
                        flameLeftSprite.getMyPixels(), 0, 33920);

            System.arraycopy(flameRightBackground.canvasRaster, 0,
                        flameRightSprite.getMyPixels(), 0, 33920);
      ...
      void startUp() {
            ...
            if (SignLink.cache_dat != null) {
                  for (int i = 0; i < 5; i++)
                        indices[i] = new Store(SignLink.cache_dat, SignLink.indices[i], i + 1);
            }
            try {
      ...
      private void markMinimap(Sprite sprite, int x, int y) {
            ...
            if (frameMode == ScreenMode.FIXED) {
                  ...
                  sprite.drawSprite(
                              ((77 + spriteOffsetX) - sprite.getMaxWidth() / 2) + 4 + 5
                                          + (frameWidth - 167),
      ...
      private void loadHpOrb(int xOffset) {
            ...
            if (percent <= .25) {
            	SpriteCache.lookup(9).drawSprite1(33 + xOffset, 52,
      ...
      private void loadPrayerOrb(int xOffset) {
            ...
            if (percent <= .25) {
            	SpriteCache.lookup(10).drawSprite1(30 + xOffset, 92,
                              200 + (int) (50 * Math.sin(tick / 7.0)));
            } else {
      ...
      private DataInputStream requestCacheIndex(String request) throws IOException {
            ...
            InputStream inputstream = jaggrab.getInputStream();
      ...
      private void doFlamesDrawing() {
            ...
            System.arraycopy(flameLeftSprite.getMyPixels(), 0,
            ...
            flameLeftBackground.drawGraphics(0, super.graphics, 0);
            System.arraycopy(flameRightSprite.getMyPixels(), 0,
